"""
mPLUG Image Captioning: inference code
"""
import argparse
import os
...
def main(args, config):
    ...
    print(f"Start training args.is_train={args.is_train}")
...
if __name__ == '__main__':
    ...
    parser.add_argument('--checkpoint', default='./checkpoints/mplug_base.pth')
    parser.add_argument('--output_dir', default='./checkpoints/mPLUG_imageCaptioning')
